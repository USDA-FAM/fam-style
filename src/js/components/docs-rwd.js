...
$('body').on('click', '[data-behavior~="toggle-rwd-size"]', function(event) {
  ...
  $self
    .removeClass('fam-bg:hover--tertiary-100')
    .addClass('fam-bg--secondary-100')
    .attr('aria-selected', true)
    .siblings()
    .removeClass('fam-bg--secondary-100')
    .removeAttr('aria-selected')
    .addClass('fam-bg:hover--tertiary-100')
  ;
...
$('body').on('change', '[data-behavior~="toggle-rwd-table"]', function(event) {
  ...
  $target.toggleClass('fam-table--responsive-horizontal');
