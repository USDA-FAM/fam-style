...
Helper.forEach(selectMulti__triggers, function(index, value) {
  ...
  _el.addEventListener('click', function(e){
    ...
    var _check = e.target;
    //var _parent = el.closest('.fam-select-multi');
    var _parent = Helper.getClosest(_el, '.fam-select-multi');
...
function selectMulti__setState(){
  ...
  Helper.forEach(_selectAll, function (index, value) {
    ...
    //var _parent = value.closest('.fam-select-multi');
    var _parent = Helper.getClosest(value, '.fam-select-multi');
