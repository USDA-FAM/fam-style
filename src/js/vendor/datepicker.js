...
var datePickerController = (function datePickerController() {
  ...
  var debug = false,
    ...
    yPartsRegExp = /%[y|Y]/,
    noSelectionRegExp = /fam-date-calendar__day--unused|fam-date-calendar__day--out-of-range|fam-date-calendar__day--disabled|fam-date-calendar__day--not-selectable/,
  ...
  function datePicker(options) {
    ...
    this.removeOldFocus = function() {
      var td = document.getElementById(o.id + "-fam-date-calendar__day--hover");
      if (td) {
        try {
          setTabIndex(td, -1);
          removeClass(td, "fam-date-calendar__day--hover");
          td.id = "";
          td.onblur = null;
          td.onfocus = null;
        } catch (err) {};
    ...
    this.setNewFocus = function() {
      ...
      if (td) {
        try {
          setTabIndex(td, 0);
          addClass(td, "fam-date-calendar__day--hover");
    ...
    this.addAccessibleDate = function() {
      ...
      if (td && !(td.getElementsByTagName("span").length)) {
        var ymd = td.className.match(/fam-date-calendar__yyyymmdd--([\d]{4})([\d]{2})([\d]{2})/),
      ...
      for (var curr = 0; curr < 42; curr++) {
        ...
        if ((curr > firstColIndex && curr <= (firstColIndex + dpm)) || o.fillGrid) {
          ...
          if (dt < 1) {
            ...
            cName.push("fam-date-calendar__day--month-out");
          ...
          cName.push("fam-date-calendar__day fam-date-calendar__day--" + weekDay + " fam-date-calendar__cell--" + curr);
          ...
          if (o.rangeLow && +currentDate < +o.rangeLow || o.rangeHigh && +currentDate > +o.rangeHigh) {
            ...
            td.className = "fam-date-calendar__day fam-date-calendar__day--out-of-range";
            ...
            // is false then give the cell a fam-date-calendar__yyyymmdd--YYYYMMDD class
            if (selectable) {
              //td.title = titleFormat ? printFormattedDate(new Date(+String(currentStub).substr(0,4), +String(currentStub).substr(4, 2) - 1, +dt), titleFormat, true) : "";
              cName.push("fam-date-calendar__yyyymmdd--" + currentDate + " fam-date-calendar__yyyymm--" + currentStub + " fam-date-calendar__mmdd--" + currentStub.substr(4, 2) + pad(dt));
              // Otherwise give a "fam-date-calendar__day--not-selectable" class (which shouldn't be styled in any way, it's for internal use)
            } else {
              //td.title = titleFormat ? getTitleTranslation(13) + " " + printFormattedDate(new Date(+String(currentStub).substr(0,4), +String(currentStub).substr(4, 2) - 1, +dt), titleFormat, true) : "";
              cName.push("fam-date-calendar__yyyymm--" + currentStub + " fam-date-calendar__mmdd--" + currentStub.substr(4, 2) + pad(dt) + " fam-date-calendar__day--not-selectable");
            };

            // Add a classname if the current cells date is today
            if (currentDate == today) {
              cName.push("fam-date-calendar__day--today");
            };

            // If this cell represents the currently selected date
            if (dateSetD == currentDate) {
              // Add a classname (for styling purposes)
              cName.push("fam-date-calendar__day--selected-date");
            ...
            if (((currentDate in dts) && dts[currentDate] == 1)
              ...
              // Add a classname to style the cell and stop selection
              cName.push("fam-date-calendar__day--disabled");
            ...
            if (o.highlightDays[weekDay]) {
              cName.push("fam-date-calendar__day--highlight");
            };

            // Is the current onscreen cursor set to this cells date
            if (cursorDate == currentDate) {
              td.id = o.id + "-fam-date-calendar__day--hover";
            };
            ...
            if (o.showWeeks) {
              cellAdded[row] = Math.min(cName[0] == "fam-date-calendar__day--month-out" ? 3 : 1, cellAdded[row]);
            };
          };
          // The current TD node is empty i.e. represents no date in the UI
        } else {
          // Add a classname to style the cell
          td.className = "fam-date-calendar__day fam-date-calendar__day--unused";
        ...
        if (o.showWeeks && curr - (row * 7) == 6) {
          ...
          o.wkThs[row].className = "fam-date-calendar__week-header" + (["", "", " fam-date-calendar__day--out-of-range", " fam-date-calendar__day--month-out", ""][cellAdded[row]]);
        };
      };
    ...
    this.create = function() {
      ...
      this.div.className = "fam-date-calendar" + this.bespokeClass;
      ...
      this.table.className = "fam-date-calendar__table";
      ...
      var dragEnabledCN = !this.dragDisabled ? " fam-date-calendar--drag-enabled" : "";
      ...
      if (!this.staticPos) {
        ...
        this.div.className += " fam-date-calendar--static";
        ...
        if (this.hideInput) {
          for (var elemID in this.formElements) {
            elem = document.getElementById(elemID);
            if (elem) {
              elem.className += " fam-date-control__date-input-hidden";
            };
          };
        };
      ...
      if (this.statusFormat) {
        ...
        tr.className = "fam-date-calendar__tfoot";
        tableFoot.appendChild(tr);
        this.statusBar = createTH({
          thClassName: "fam-date-calendar__status-bar" + dragEnabledCN,
      ...
      tableHead.className = "fam-date-calendar__thead";
      ...
      this.titleBar = createTH({
        thClassName: "fam-date-calendar__title" + dragEnabledCN,
        colspan: this.showWeeks ? 8 : 7
      });
      ...
      span.className = "fam-date-calendar__title-month" + dragEnabledCN;
      this.titleBar.appendChild(span);

      span = document.createElement('span');
      span.appendChild(document.createTextNode(nbsp));
      span.className = "fam-date-calendar__title-year" + dragEnabledCN;
      this.titleBar.appendChild(span);
      ...
      createThAndButton(tr, [{
        className: "fam-date-calendar__prev-but fam-date-calendar__prev-but--year",
        id: "-prev-year-but",
        text: "\u00AB",
        title: getTitleTranslation(2)
      }, {
        className: "fam-date-calendar__prev-but fam-date-calendar__prev-but--month",
        id: "-prev-month-but",
        text: "\u2039",
        title: getTitleTranslation(0)
      }, {
        colspan: this.showWeeks ? 4 : 3,
        className: "fam-date-calendar__today-but",
        id: "-today-but",
        text: getTitleTranslation(4),
        title: "Go to" + " " + getTitleTranslation(4)
      }, {
        className: "fam-date-calendar__next-but fam-date-calendar__next-but--month",
        id: "-next-month-but",
        text: "\u203A",
        title: getTitleTranslation(1)
      }, {
        className: "fam-date-calendar__next-but fam-date-calendar__next-but--year",
        id: "-next-year-but",
        text: "\u00BB",
        ...
        for (var cols = 0; cols < colspanTotal; cols++) {
          ...
          if ((this.showWeeks && cols > 0 && rows > 0) || (!this.showWeeks && rows > 0)) {
            ...
            if (rows === 0 && cols > colOffset) {
              col.className = "fam-date-calendar__day--header";
              col.scope = "col";
              //commented out based on this open issue https://github.com/freqdec/datePicker/issues/42
              //setARIARole(col, "columnheader");
              col.id = this.id + "-col-" + cols;
            } else {
              col.className = "fam-date-calendar__week-header";
              col.scope = "row";
              //commented out based on this open issue https://github.com/freqdec/datePicker/issues/42
      ...
      for (var y = 0; y < colspanTotal; y++) {
        ...
        if (y > (this.showWeeks ? 0 : -1)) {
          ...
          but.className = "fam-date-calendar__day-name";
      ...
      if (this.showWeeks) {
        ...
        this.div.className += " fam-date-calendar--weeks-displayed";
      };
    ...
    this.stopDrag = function(e) {
      ...
      removeClass(b, "fam-date-calendar-is-dragging");
    ...
    this.onmousedown = function(e) {
      ...
      if ((o.div.className + origEl.className).search('fam-date-calendar__disabled-item') != -1) {
        return true;
      };
      ...
      if (origEl.id.search(new RegExp("^" + o.id + "(-prev-year-but|-prev-month-but|-next-month-but|-next-year-but)$")) != -1) {
      ...
      } else if (el.className.search("fam-date-calendar--drag-enabled") != -1) {
        ...
        addClass(document.getElementsByTagName("body")[0], "fam-date-calendar-is-dragging");
    ...
    this.onclick = function(e) {
      ...
      while (el.parentNode) {
        ...
        if (el.tagName && el.tagName.toLowerCase() == "td") {
          ...
          if (el.className.search(/fam-date-calendar__yyyymmdd--([0-9]{8})/) == -1 || el.className.search(noSelectionRegExp) != -1) {
            return stopEvent(e);
          };

          var cellDate = el.className.match(/fam-date-calendar__yyyymmdd--([0-9]{8})/)[1];
        ...
        } else if (el.className.search(/fam-date-calendar__day--header/) != -1) {
    ...
    this.show = function(autoFocus) {
      ...
      if (butt) {
        addClass(butt, "fam-date-control__btn--active");
      };
    };
    this.hide = function() {
      ...
      removeClass(o.div, "fam-date-calendar--focus");
      ...
      var butt = document.getElementById('fd-but-' + this.id);
      if (butt) {
        removeClass(butt, "fam-date-control__btn--active");
      };
    ...
    this.onfocus = function(e) {
      o.noFocus = false;
      addClass(o.div, "fam-date-calendar--focus");
      if (o.statusBar) {
    ...
    this.onkeydown = function(e) {
      ...
      if (kc == 13 || (kc == 32 && !e.ctrlKey)) {
        ...
        var td = document.getElementById(o.id + "-fam-date-calendar__day--hover");
        if (!td || td.className.search(/fam-date-calendar__yyyymmdd--([0-9]{8})/) == -1 || td.className.search(/fam-date-calendar__day--out-of-range|fam-date-calendar__day--disabled/) != -1) {
          return stopEvent(e);
        };
        o.dateSet = new Date(o.date);
        o.callback("dateset", o.createCbArgObj());
      ...
      if (e.ctrlKey || (kc == 33 || kc == 34) || t < o.firstDateShown || t > o.lastDateShown) {
        ...
        for (var i = 0, td; td = o.tds[i]; i++) {
          if (td.className.search("fam-date-calendar__yyyymmdd--" + t) == -1) {
            continue;
          };
    ...
    this.onmouseover = function(e) {
      ...
      switch (el.tagName.toLowerCase()) {
        case "td":
          if (el.className.search(/fam-date-calendar__day--unused|fam-date-calendar__day--out-of-range/) != -1) {
            statusText = getTitleTranslation(9);
          }
          if (el.className.search(/fam-date-calendar__yyyymmdd--([0-9]{8})/) != -1) {
            o.stopTimer();
            var cellDate = el.className.match(/fam-date-calendar__yyyymmdd--([0-9]{8})/)[1];

            o.removeOldFocus();
            el.id = o.id + "-fam-date-calendar__day--hover";
            o.setNewFocus();
        ...
        case "th":
          ...
          if (el.className.search(/fam-date-calendar--drag-enabled/) != -1) {
            statusText = getTitleTranslation(10);
          } else if (el.className.search(/fam-date-calendar__week-header/) != -1) {
        ...
        case "span":
          ...
          if (el.className.search(/fam-date-calendar--drag-enabled/) != -1) {
            statusText = getTitleTranslation(10);
          } else if (el.className.search(/fam-date-calendar__day--([0-6])/) != -1) {
            var day = el.className.match(/fam-date-calendar__day--([0-6])/)[1];
            statusText = getTitleTranslation(11, [getDayTranslation(day, false)]);
          } else if (el.className.search(/fam-date-calendar__prev-but--year/) != -1) {
            statusText = getTitleTranslation(2);
          } else if (el.className.search(/fam-date-calendar__prev-but--month/) != -1) {
            statusText = getTitleTranslation(0);
          } else if (el.className.search(/fam-date-calendar__next-but--year/) != -1) {
            statusText = getTitleTranslation(3);
          } else if (el.className.search(/fam-date-calendar__next-but--month/) != -1) {
            statusText = getTitleTranslation(1);
          } else if (el.className.search(/fam-date-calendar__today-but/) != -1 && el.className.search(/disabled/) == -1) {
      ...
      while (el.parentNode) {
        ...
        if (el.nodeType == 1 && el.tagName.toLowerCase() == "tr") {
          ...
          el.className = "fam-date-calendar__row--highlight";
          o.currentTR = el;
          break;
        };
      };
  ...
  datePicker.prototype.addButtonEvents = function(but) {
    function buttonEvent(e) {
      ...
      if (e.type == "keydown") {
        ...
        if (dpVisible) {
          removeClass(this, "fam-date-control__btn--active")
          hideAll();
          return stopEvent(e);
        };
        autoFocus = true;
      ...
      if (!dpVisible) {
        addClass(this, "fam-date-control__btn--active")
        hideAll(inpId);
  ...
  datePicker.prototype.createButton = function() {
    ...
    wrap.className = "fam-date-control";

    // but.href = "#" + this.id;
    but.className = "fam-date-control__btn";
    //but.title       = getTitleTranslation(5);
    but.id = "fd-but-" + this.id;
    but.setAttribute("type", "button");
    but.setAttribute("title", "Open Calendar");
    // span.className = "fam-date-control__icon-wrapper";
    ...
    // fontIconHolder.className = "fam-date-control__icon";
    fontIconHolder.style.fontFamily = "";
    fontIconHolder.innerHTML = '<span class="fam-date-control__text">Open Calendar</span>';
  ...
  datePicker.prototype.setDateFromInput = function() {
    ...
    if (but) {
      removeClass(but, "fam-date-control__btn--date-is-valid");
    };
    ...
    if (dt.getTime() == this.date.getTime() && this.canDateBeSelected(this.date)) {
      ...
      if (but) {
        addClass(but, "fam-date-control__btn--date-is-valid");
      };
    };
  ...
  datePicker.prototype.disableDatePicker = function() {
    ...
    if (this.staticPos) {
      ...
      this.removeOldFocus();
      this.noFocus = true;
      addClass(this.div, "fam-date-calendar--disabled")
      ...
      if (but) {
        addClass(but, "fam-date-control__btn--disabled");
  ...
  datePicker.prototype.enableDatePicker = function() {
    ...
    if (this.staticPos) {
      ...
      this.noFocus = true;
      this.updateTable();
      removeClass(this.div, "fam-date-calendar--disabled");
      this.disabled = false;
      this.table.onmouseover = this.onmouseover;
      this.table.onmouseout = this.onmouseout;
      this.table.onclick = this.onclick;
      ...
      var but = document.getElementById("fd-but-" + this.id);
      if (but) {
        removeClass(but, "fam-date-control__btn--disabled");
  ...
  datePicker.prototype.disableTodayButton = function() {
    var today = new Date();
    removeClass(this.butToday, "fam-date-calendar__disabled-item");
    if (this.outOfRange(today) ||
      (this.date.getDate() == today.getDate() &&
        this.date.getMonth() == today.getMonth() &&
        this.date.getFullYear() == today.getFullYear())
    ) {
      addClass(this.butToday, "fam-date-calendar__disabled-item");
    };
  };
  datePicker.prototype.updateTableHeaders = function() {
    ...
    for (var col = colOffset; col < colspanTotal; col++) {
      ...
      removeClass(this.ths[col], "fam-date-calendar__day--highlight");
      if (this.highlightDays[d]) {
        addClass(this.ths[col], "fam-date-calendar__day--highlight");
      };
    };
  ...
  datePicker.prototype.showHideButtons = function(tmpDate) {
    ...
    if (this.outOfRange(new Date((tdy - 1), tdm, daysInMonth(+tdm, tdy - 1)))) {
      addClass(this.butPrevYear, "fam-date-calendar__disabled-item");
      if (this.yearInc == -1) {
        this.stopTimer();
      };
    } else {
      removeClass(this.butPrevYear, "fam-date-calendar__disabled-item");
    };

    if (this.outOfRange(new Date(tdy, (+tdm - 1), daysInMonth(+tdm - 1, tdy)))) {
      addClass(this.butPrevMonth, "fam-date-calendar__disabled-item");
      if (this.monthInc == -1) {
        this.stopTimer();
      };
    } else {
      removeClass(this.butPrevMonth, "fam-date-calendar__disabled-item");
    };

    if (this.outOfRange(new Date((tdy + 1), +tdm, 1))) {
      addClass(this.butNextYear, "fam-date-calendar__disabled-item");
      if (this.yearInc == 1) {
        this.stopTimer();
      };
    } else {
      removeClass(this.butNextYear, "fam-date-calendar__disabled-item");
    };

    if (this.outOfRange(new Date(tdy, +tdm + 1, 1))) {
      addClass(this.butNextMonth, "fam-date-calendar__disabled-item");
      if (this.monthInc == 1) {
        this.stopTimer();
      };
    } else {
      removeClass(this.butNextMonth, "fam-date-calendar__disabled-item");
    };
  };
  var localeDefaults = {
